...
export const ko: Dict = {
  ...
  'homeWorkingDir.browseServer': 'Browse server folders',
  'serverDirectoryPicker.title': 'Browse server folders',
  'serverDirectoryPicker.subtitle': 'Choose a folder that the Open Design daemon can access.',
  'serverDirectoryPicker.close': 'Close server folder browser',
  'serverDirectoryPicker.closeTitle': 'Close',
  'serverDirectoryPicker.rootsAria': 'Server folder roots',
  'serverDirectoryPicker.up': 'Go to parent folder',
  'serverDirectoryPicker.upTitle': 'Up one folder',
  'serverDirectoryPicker.loading': 'Loading...',
  'serverDirectoryPicker.retry': 'Retry',
  'serverDirectoryPicker.newFolder': 'New folder',
  'serverDirectoryPicker.folderName': 'Folder name',
  'serverDirectoryPicker.folderNamePlaceholder': 'Folder name',
  'serverDirectoryPicker.createFolder': 'Create folder',
  'serverDirectoryPicker.createFolderFailed': 'Could not create folder.',
  'serverDirectoryPicker.openFolderAria': 'Open {name}',
  'serverDirectoryPicker.folder': 'Folder',
  'serverDirectoryPicker.file': 'File',
  'serverDirectoryPicker.empty': 'This folder is empty.',
  'serverDirectoryPicker.truncated': 'Showing the first 500 entries.',
  'serverDirectoryPicker.cancel': 'Cancel',
  'serverDirectoryPicker.select': 'Select folder',
  'serverDirectoryPicker.loadDirectoryFailed': 'Could not load this folder.',
  'serverDirectoryPicker.noRoots': 'No server folders are available.',
  'serverDirectoryPicker.loadRootsFailed': 'Could not load server folders.',
