...
export const zhTW: Dict = {
  ...
  'homeWorkingDir.browseServer': '瀏覽伺服器資料夾',
  'serverDirectoryPicker.title': '瀏覽伺服器資料夾',
  'serverDirectoryPicker.subtitle': '選擇 Open Design 守護程式可以存取的資料夾。',
  'serverDirectoryPicker.close': '關閉伺服器資料夾瀏覽器',
  'serverDirectoryPicker.closeTitle': '關閉',
  'serverDirectoryPicker.rootsAria': '伺服器資料夾根目錄',
  'serverDirectoryPicker.up': '返回上層資料夾',
  'serverDirectoryPicker.upTitle': '上一層',
  'serverDirectoryPicker.loading': '正在載入...',
  'serverDirectoryPicker.retry': '重試',
  'serverDirectoryPicker.newFolder': '新增資料夾',
  'serverDirectoryPicker.folderName': '資料夾名稱',
  'serverDirectoryPicker.folderNamePlaceholder': '資料夾名稱',
  'serverDirectoryPicker.createFolder': '建立資料夾',
  'serverDirectoryPicker.createFolderFailed': '無法建立資料夾。',
  'serverDirectoryPicker.openFolderAria': '開啟 {name}',
  'serverDirectoryPicker.folder': '資料夾',
  'serverDirectoryPicker.file': '檔案',
  'serverDirectoryPicker.empty': '此資料夾是空的。',
  'serverDirectoryPicker.truncated': '僅顯示前 500 個項目。',
  'serverDirectoryPicker.cancel': '取消',
  'serverDirectoryPicker.select': '選擇資料夾',
  'serverDirectoryPicker.loadDirectoryFailed': '無法載入此資料夾。',
  'serverDirectoryPicker.noRoots': '沒有可用的伺服器資料夾。',
  'serverDirectoryPicker.loadRootsFailed': '無法載入伺服器資料夾。',
