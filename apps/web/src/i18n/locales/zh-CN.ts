...
export const zhCN: Dict = {
  ...
  'homeWorkingDir.browseServer': '浏览服务器文件夹',
  'serverDirectoryPicker.title': '浏览服务器文件夹',
  'serverDirectoryPicker.subtitle': '选择 Open Design 守护进程可以访问的文件夹。',
  'serverDirectoryPicker.close': '关闭服务器文件夹浏览器',
  'serverDirectoryPicker.closeTitle': '关闭',
  'serverDirectoryPicker.rootsAria': '服务器文件夹根目录',
  'serverDirectoryPicker.up': '返回上级文件夹',
  'serverDirectoryPicker.upTitle': '上一级',
  'serverDirectoryPicker.loading': '正在加载...',
  'serverDirectoryPicker.retry': '重试',
  'serverDirectoryPicker.newFolder': '新建文件夹',
  'serverDirectoryPicker.folderName': '文件夹名称',
  'serverDirectoryPicker.folderNamePlaceholder': '文件夹名称',
  'serverDirectoryPicker.createFolder': '创建文件夹',
  'serverDirectoryPicker.createFolderFailed': '无法创建文件夹。',
  'serverDirectoryPicker.openFolderAria': '打开 {name}',
  'serverDirectoryPicker.folder': '文件夹',
  'serverDirectoryPicker.file': '文件',
  'serverDirectoryPicker.empty': '此文件夹为空。',
  'serverDirectoryPicker.truncated': '仅显示前 500 个条目。',
  'serverDirectoryPicker.cancel': '取消',
  'serverDirectoryPicker.select': '选择文件夹',
  'serverDirectoryPicker.loadDirectoryFailed': '无法加载此文件夹。',
  'serverDirectoryPicker.noRoots': '没有可用的服务器文件夹。',
  'serverDirectoryPicker.loadRootsFailed': '无法加载服务器文件夹。',
